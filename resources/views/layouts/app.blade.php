        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('unitproduksi') ? 'active' : ''}}" aria-current="page" href="{{ url('unitproduksi' )}}">Data Unit Produksi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('produk') ? 'active' : ''}}" aria-current="page" href="{{ url('produk' )}}">Data Produk</a>
                        </li>
                    </ul>
                    @endguest
